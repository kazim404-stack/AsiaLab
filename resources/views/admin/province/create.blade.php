...
@endphp
<div class="modal fade" id="create-province" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form  method="post" id="province-form" action="{{ route('admin.provinces.store') }}">
                    @csrf
                    <div class="row">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="store-province"><i
