...
@endphp
<div class="modal fade" id="edit-general-setting" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.general-settings.store') }}" method="post" id="edit-general-setting-form"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <img alt="show-logo" id="show-logo" width="150">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="update-general-setting"><i
