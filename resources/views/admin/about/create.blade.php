...
@endphp
<div class="modal fade" id="create-about" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.about.store') }}" method="post" id="about-form"
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="store-about"><i
