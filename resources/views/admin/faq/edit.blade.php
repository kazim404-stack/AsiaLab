    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
                ...
                <form method="post" id="edit-faq-form">
                    ...
                    <div class="row">
                        @foreach ($languages as $local => $label)
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="question[{{ $local }}]" class="col-form-label">Question</label>
                        ...
                        @foreach ($languages as $local => $label)
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="contact{{ $local }}" class="col-form-label">Answear</label>
                                    <textarea name="answear[{{ $local }}]" id="answear[{{ $local }}]" placeholder="Enter answear in {{ $label }}" class="form-control"></textarea>
                                </div>
                            </div>
                        @endforeach
                        <div class="col-md-12">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="update-faq"><i
